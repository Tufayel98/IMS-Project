...
public class ItemControllerTest {
	...
	public void testCreate() {
		final Long Id = 2L;
		final String itemName = "Rolex";
		final Float price = 5000.00f;
		final Item created = new Item(Id, itemName, price);
	...
	public void testReadAll() {
		...
		items.add(new Item(2L, "Rolex", 5000.00f));
	...
	public void testUpdate() {
		Item updated = new Item(2L, "Hublot", 10000.00f);
